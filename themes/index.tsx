...
// types
import { CustomShadowProps } from '@interfaces/UI/default-theme.interface';
import { ColorProps } from '@interfaces/UI/general.interface';
...
export default function ThemeCustomization({ children }: Props) {
  ...
  const { borderRadius, isLoadingSettings, fontFamily, navType, outlinedFilled, presetColor, rtlLayout } = useConfig();
  ...
  return (
    <>
   {isLoadingSettings ? null: <StyledEngineProvider injectFirst>
